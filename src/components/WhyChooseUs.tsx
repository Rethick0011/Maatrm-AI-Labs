const features = [
  'Direct communication from idea to launch',
    ...
    <section id="why" className="py-24 bg-bg-base">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-400 text-center max-w-3xl mx-auto mb-16">
          We combine the speed of a freelance team with the seriousness of a long-term technology partner, making each product practical, maintainable, and aligned with business priorities.
        </p>
