      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-8">
          <div className="bg-bg-card rounded-2xl border border-border p-8">
            <h3 className="font-heading text-2xl font-semibold text-white mb-6">Contact Details</h3>
            <div className="space-y-5">
              <div className="rounded-xl border border-border p-5 hover:border-gold transition-all">
                <span className="text-gold text-sm uppercase tracking-widest">Phone</span>
